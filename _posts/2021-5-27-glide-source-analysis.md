...
![ApiGlideModule](https://malinkang-1253444926.cos.ap-beijing.myqcloud.com/blog/images/ApiGlideModule.png)
...
![DiskCache类图](/Users/malinkang/Downloads/DiskCache.png)
...
```java
interface Factory {
    int DEFAULT_DISK_CACHE_SIZE = 250 * 1024 * 1024;//默认250M
    String DEFAULT_DISK_CACHE_DIR = "image_manager_disk_cache"; //默认存储文件夹
    @Nullable
    DiskCache build();
  }
```
...
![Glide-Lifecycle](https://malinkang-1253444926.cos.ap-beijing.myqcloud.com/blog/images/Glide-Lifecycle.png)
...
![LifecycleListener](https://malinkang-1253444926.cos.ap-beijing.myqcloud.com/blog/images/LifecycleListener.png)
...
![Glide-RequestBuilder](https://malinkang-1253444926.cos.ap-beijing.myqcloud.com/blog/images/Glide-RequestBuilder.png)
...
![Glide请求过程](https://malinkang-1253444926.cos.ap-beijing.myqcloud.com/blog/images/Glide请求过程.png)

![Glide编码过程 ](https://malinkang-1253444926.cos.ap-beijing.myqcloud.com/blog/images/Glide编码过程 .png)
